...
MORFI is a training-free framework that uses Vision-Language Models (VLMs) to predict stock prices by combining line chart images with numerical time-series data, and outperforms text-only LLMs by 40–80% in MSE.
